...
<head>
    ...
    <title>@yield('title', 'Artika - Là où l\'art prend vie')</title>
...
<body>
    ...
    <header class="header">
        <div class="container-header">
            ...
            <div class="logo">
                <a href="{{ url('/') }}">
                    <img src="{{ asset('resources\images\ARTIKA_blk.png') }}" alt="Artika">
                </a>
            </div>
                        ...
                        <div class="megamenu">
                            <div class="megamenu-content">
                                ...
                                <div class="megamenu-images">
                                    <img src="{{ asset('resources\images\accueil\materiel.jpg') }}" alt="Peinture 1" class="megamenu-img img-1">
                                    <img src="{{ asset('resources\images\accueil\product1.jpg') }}" alt="Peinture 2" class="megamenu-img img-2">
                                    <img src="{{ asset('resources\images\accueil\materiel.jpg') }}" alt="Peinture 3" class="megamenu-img img-3">
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item has-megamenu">
                        ...
                        <div class="megamenu">
                            <div class="megamenu-content">
                                ...
                                <div class="megamenu-images">
                                    <img src="{{ asset('resources\images\accueil\materiel.jpg') }}" alt="Accessoire 1" class="megamenu-img img-1">
                                    <img src="{{ asset('resources\images\accueil\peintures.jpg') }}" alt="Accessoire 2" class="megamenu-img img-2">
                                    <img src="{{ asset('resources\images\accueil\sculptures.jpg') }}" alt="Accessoire 3" class="megamenu-img img-3">
                                </div>
                            </div>
                        </div>
                    </li>
                            ...
                            <div class="megamenu-content">
                                <div class="megamenu-links">
                                    ...
                                    <ul class="megamenu-list">
                                        ...
                                        <li><a href="dessins_eau.html">Dessin à eau</a></li>
                                    </ul>
                                </div>
                                <div class="megamenu-images">
                                    <img src="{{ asset('resources\images\accueil\peintures.jpg') }}" alt="Dessin 1" class="megamenu-img img-1">
                                    <img src="{{ asset('resources\images\accueil\hero.jpg') }}" alt="Dessin 2" class="megamenu-img img-2">
                                    <img src="{{ asset('resources\images\accueil\product1.jpg') }}" alt="Dessin 3" class="megamenu-img img-3">
                                </div>
                            </div>
                        </div>
                    </li>
            ...
            <div class="header-actions">
                ...
                <a href="panier.html" class="icon-btn cart-icon" aria-label="Panier">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <div class="mini-panier-contenu" id="panierContenu" style="display: none;">
            ...
            <div class="mini-panier-footer">
                <div class="mini-panier-total">
                    <span>Total :</span>
                    <span class="total-prix" id="totalPanier">0 FCFA</span>
                </div>
        ...
        <div class="container">
            ...
            <div class="footer-content">
                ...
                <div class="footer-column">
                    <h4 class="footer-title">Artika</h4>
                    <p class="footer-text">Là où l'art prend vie.</p>
                    <p class="footer-text">Votre galerie d'art en ligne pour découvrir et acquérir des œuvres uniques.</p>
                </div>
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-links">
                        <li><a href="mailto:contact@artika.com">contact@artika.com</a></li>
                        <li><a href="tel:+237600000000">+237 6XX XX XX XX</a></li>
    ...
    <script src="{{ asset('resources\js\accueil.js') }}"></script>
    @yield('scripts')
