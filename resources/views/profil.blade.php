...
<html lang="fr">
  ...
  <body>
    ...
    <div class="promo-banner">
      <p>
        Livraison gratuite pour les commandes de plus de 75 000 FCFA. Retours
        faciles.
      </p>
    </div>
    <header class="header">
      <div class="container-header">
        ...
        <div class="logo">
          <a href="artika.html">
            <img src="{{ asset('images/ARTIKA_blk.png') }}" alt="Artika" />
          </a>
        </div>
        ...
        <nav class="main-nav">
          <ul class="nav-list">
                ...
                <div class="megamenu-content">
                  <div class="megamenu-links">
                    ...
                    <ul class="megamenu-list">
                      ...
                      <li>
                        <a href="peinturepaysage.html">Peinture Paysage</a>
                      </li>
                  ...
                  <div class="megamenu-images">
                    <img
                      src="{{ asset('images/accueil/materiel.jpg') }}"
                      alt="Peinture 1"
                      class="megamenu-img img-1"
                    />
                    <img
                      src="{{ asset('images/accueil/product1.jpg') }}"
                      alt="Peinture 2"
                      class="megamenu-img img-2"
                    />
                    <img
                      src="{{ asset('images/accueil/materiel.jpg') }}"
                      alt="Peinture 3"
                      class="megamenu-img img-3"
                    />
                  </div>
                </div>
              </div>
              ...
              <div class="megamenu">
                <div class="megamenu-content">
                  ...
                  <div class="megamenu-images">
                    ...
                    />
                    <img
                      src="{{ asset('images/accueil/peintures.jpg') }}"
                      alt="Accessoire 2"
                      class="megamenu-img img-2"
                    />
                    <img
                      src="{{ asset('images/accueil/sculptures.jpg') }}"
                      alt="Accessoire 3"
                      class="megamenu-img img-3"
                    />
                  </div>
              ...
              <div class="megamenu">
                <div class="megamenu-content">
                  <div class="megamenu-links">
                    ...
                    <ul class="megamenu-list">
                      <li>
                        <a href="dessin_portrait.html">Dessin de portrait</a>
                      </li>
                  ...
                  <div class="megamenu-images">
                    ...
                    />
                    <img
                      src="{{ asset('images/accueil/hero.jpg') }}"
                      alt="Dessin 2"
                      class="megamenu-img img-2"
                    />
                    <img
            ...
            <!-- Liens simples -->
            <li class="nav-item">
              <a href="magasins.html" class="nav-link">Nos magasins</a>
            </li>
            <li class="nav-item">
        ...
        <!-- Actions utilisateur (Recherche, Login, Panier) -->
				<div class="header-actions">
					...
					<!-- Icône Login (pour non connectés) -->
					<a href="{{ route('login') }}" class="icon-btn icon-login" aria-label="Se connecter" title="Se connecter">
						<svg width="20" height="20" viewBox="0 0 20 20" fill="none">
					...
					<!-- Dropdown Profil (pour connectés) -->
					<div class="profile-dropdown-wrapper" style="display: none;">
						...
						<div class="profile-dropdown" style="display: none;">
							<div class="profile-dropdown-header">
								<span id="nom-utilisateur-dropdown">Utilisateur</span>
							</div>
							...
							<button id="btn-deconnexion" class="profile-dropdown-item">
    ...
    <main class="main-content">
      <div class="profile-container">
        ...
        <section class="profile-section">
          ...
          <div id="erreur-reseau-infos" class="div-erreur"></div>
        ...
        <section class="profile-section">
          <h2 class="section-title">Nouveau mot de passe</h2>
					<div id="erreur-reseau-mdp" class="div-erreur"></div>
          <form class="profile-form">
      ...
      <div class="container">
        ...
        <div class="footer-content">
          ...
          <div class="footer-column">
            ...
            <p class="footer-text">
              Votre galerie d'art en ligne pour découvrir et acquérir des œuvres
              uniques.
            </p>
          </div>
          ...
          <div class="footer-column">
            ...
            <ul class="footer-links">
              <li>
                <a href="mailto:contact@artika.com">contact@artika.com</a>
              </li>
